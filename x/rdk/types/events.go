...
const (
	EventRollupCreated    = "rollup_created"
	EventRollupPaused     = "rollup_paused"
	EventRollupResumed    = "rollup_resumed"
	...
	EventDABlobPruned     = "da_blob_pruned"
	EventProfileSuggested = "profile_suggested"
)
