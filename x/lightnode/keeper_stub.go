...
func (k *StubKeeper) ClaimRewards(_ sdk.Context, _ string) (math.Int, error)        { return math.ZeroInt(), nil }
func (k *StubKeeper) GetStats(_ sdk.Context) types.LightNodeStats                   { return types.DefaultLightNodeStats() }
func (k *StubKeeper) InitGenesis(_ sdk.Context, _ types.GenesisState)               {}
func (k *StubKeeper) ExportGenesis(_ sdk.Context) *types.GenesisState               { return types.DefaultGenesisState() }
